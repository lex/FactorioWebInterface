...
class ModPackFileNameColumn extends ColumnTemplate {
    constructor(modPackFilesViewModel) {
        super();
        this.property = 'Name';
        this.cell = (name) => {
...
export class ModPackFilesView extends VirtualComponent {
    constructor(modPackFilesViewModel) {
        ...
        function updateDownloadButton(isDeflating) {
            if (isDeflating) {
...
//# sourceMappingURL=modPackFilesView.js.map