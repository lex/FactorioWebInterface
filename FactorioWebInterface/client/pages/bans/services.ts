...
export function registerBansPageServices(serviceLocator: ServiceLocator): ServiceLocator {
    serviceLocator.register(BansHubService, () => new BansHubService());

    serviceLocator.register(BansService, (services) => new BansService(
        services.get(BansHubService),
        services.get(IHiddenInputService)));

    serviceLocator.register(BansViewModel, (services) => new BansViewModel(
        services.get(BansService),
